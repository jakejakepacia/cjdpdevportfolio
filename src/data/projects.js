...
export const projects = [
  {
    ...
    title: "Kachinga",
    description:
      "Pioneering developer  as (1 of 3) for a mobile app and spend card platform designed to help parents teach kids money management. Built the app using Xamarin/C# and developed backend RESTful APIs with ASP.NET. Designed and connected MySQL databases, created stored procedures, and implemented end-to-end full-stack functionality, enabling secure transactions, account management, and real-time updates.",
    logo: KachingaIcon,
    video: KachingaDemo,
    previews: [
      kaPreview1,
    ...
    techStack:
      "Tech Stack: Xamarin, C#, ASP.NET, RESTful APIs, MySQL, Stored Procedures, iOS/Android",
  ...
  },
  {
    ...
    featuresComponent: "Tonelyo",
    techStack:
      "Swift/UIKit, MVVM, REST APIs, Fire base Push Notifications, Maps, In-App Messaging",
    company: "UnlimitedIA",
  },
  {
    id: "kwizinyo",
    ...
    featuresComponent: "Tonelyo",
    techStack:
      "Swift/UIKit, MVVM, REST APIs, Firebase Push Notifications, Maps, In-App Messaging",
    company: "UnlimitedIA",
  },
  {
    id: "poteyo",
  ...
  },
  {
    ...
    title: "Tourism App",
    description:
      "Developed a comprehensive iOS app for tourists to discover and book local attractions, restaurants, and activities. Implemented features such as location-based recommendations, in-app booking system, user reviews and ratings, and integrated payment processing for seamless transactions.",
    logo: TourismLogo,
    video: TourismDemo,
    previews: [Home, Details, DiscoverList, DiscoverMap, Saved, Profile],
    featuresComponent: "",
    techStack: "React Native Expo, TypeScript, JS, REST APIs, Maps Integration",
    company: "Self-initiated project",
    githublink: "https://github.com/jakejakepacia/AngelesTourismApp",
  },
  {
    id: "AutoMate",
    title: "AutoMate",
    description:
      "Developed a full-featured mobile application for car rental services, enabling users to browse, book, and manage vehicle rentals seamlessly. Implemented key features such as real-time vehicle availability, date-based pricing (daily/weekly/monthly), booking management, and user authentication. Integrated location services for pickup/drop-off points and built a smooth reservation flow with cost estimation. Designed an intuitive and modern UI focused on user convenience and performance.",
    logo: logo,
    video: demo,
    previews: [
      addCarSuccess,
    ...
    featuresComponent: "",
    techStack:
      "React Native Expo, TypeScript, JS, REST APIs, Maps Integration, Supabase",
    company: "Self-initiated project",
    githublink: "https://github.com/jakejakepacia/automate",
  },
];
